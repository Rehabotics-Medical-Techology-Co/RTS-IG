...
* item[=].item[0].linkId = "C-I-finger-to-nose-tremor"
* item[=].item[=].text = "手指觸碰鼻子：顫抖"
...
* item[=].item[1].linkId = "C-I-finger-to-nose-dysmetria"
* item[=].item[=].text = "手指觸鼻：辨距不良"
* item[=].item[=].type = #choice
* item[=].item[=].required = true
* item[=].item[=].answerOption[0].valueInteger = 0
* item[=].item[=].answerOption[+].valueInteger = 1
...
* item[=].item[2].linkId = "C-I-finger-to-nose-time"
* item[=].item[=].text = "手指到鼻子：時間"
* item[=].item[=].type = #choice
* item[=].item[=].required = true
* item[=].item[=].answerOption[0].valueInteger = 0
* item[=].item[=].answerOption[+].valueInteger = 1
