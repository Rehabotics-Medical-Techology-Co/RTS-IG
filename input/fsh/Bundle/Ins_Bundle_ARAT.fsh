...
// 患者資源 [0]
* entry[0].fullUrl = "https://build.fhir.org/ig/Rehabotics-Medical-Techology-Co/RTS-IG/Patient/stroke-patient-001"
...
// ARAT問卷回覆 [2]
* entry[+].fullUrl = "https://build.fhir.org/ig/Rehabotics-Medical-Techology-Co/RTS-IG/QuestionnaireResponse/arat-response-example-001"
* entry[=].resource = ARATQuestionnaireResponseExample

// 評估會期 [3]
* entry[+].fullUrl = "https://build.fhir.org/ig/Rehabotics-Medical-Techology-Co/RTS-IG/Encounter/arat-assessment-encounter-001"
