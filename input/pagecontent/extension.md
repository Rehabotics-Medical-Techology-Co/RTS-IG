...
#### CarePlan
- [PAC照護計畫](StructureDefinition-CarePlan.html)

#### Condition
- [PAC病情、問題或診斷](StructureDefinition-PACCondition.html)

#### Encounter
- [就醫事件](StructureDefinition-Encounter.html)

#### Goal
- [目標](StructureDefinition-Goal.html)

#### MedicationAdministration
- [用藥資料](StructureDefinition-MyMedicationAdministration.html)

#### Observation
- [健康狀態篩檢與評估](StructureDefinition-ObservationScreeningAssessment.html)

#### Organization
- [就醫機構](StructureDefinition-Organization.html)
...
#### Practitioner
- [健康照護服務提供者](StructureDefinition-Practitioner.html)
